...
+ (BOOL)addSystem:(NSDictionary*)dict
{
    ...
    if (count > 0)
    {
        Book *s = [[self getFormat:@"name=%@" argument:@[dict[@"name"]]] lastObject];
    ...
    Book *b = [NSEntityDescription insertNewObjectForEntityForName:@"Book" inManagedObjectContext: [db managedObjectContext]];
